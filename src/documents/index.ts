...
const registry: Readonly<Record<string, readonly CompanyDocumentConfig[]>> = {
  ...
  PR: [{
    ...
    validationLevel: "format",
    source: {
      name: "Internal Revenue Service — Puerto Rico uses the federal EIN",
  ...
  UY: [{
    ...
    example: "210000012340",
    regex: "^\\d{12}$",
    validate: (value) => /^\d{12}$/.test(digits(value)),
    validationLevel: "format",
    source: {
      name: "Dirección General Impositiva — Consulta de RUT",
  ...
  BO: [{
    ...
    example: "1234567890",
    regex: "^\\d{7,12}$",
    validate: (value) => /^\d{7,12}$/.test(digits(value)),
    validationLevel: "format",
    source: {
      name: "Servicio de Impuestos Nacionales — Padrón Nacional de Contribuyentes",
  ...
  GT: [{
    ...
    mask: maskTrailingVerifier,
    regex: "^\\d{1,8}-?[\\dK]$",
    validate: (value) => /^\d{1,8}-?[\dK]$/.test(value.trim().toUpperCase()),
    validationLevel: "format",
    source: {
      name: "Superintendencia de Administración Tributaria — Consulta NIT",
  ...
  VE: [{
    ...
    regex: "^[JGVEPC]-?\\d{8}-?\\d$",
    validate: (value) => /^[JGVEPC]-?\d{8}-?\d$/.test(value.trim().toUpperCase()),
    validationLevel: "format",
    source: {
      name: "Servicio Nacional Integrado de Administración Aduanera y Tributaria — RIF",
  ...
  DO: [{
    ...
    countryCallingCode: "+1",
    type: "RNC",
    label: "Registro Nacional de Contribuyentes",
    example: "123456789",
    regex: "^\\d{9}$|^\\d{11}$",
    validate: (value) => /^\d{9}$|^\d{11}$/.test(digits(value)),
    validationLevel: "format",
    source: {
      name: "Dirección General de Impuestos Internos — Consulta RNC",
  ...
  CR: [{
    ...
    regex: "^\\d{10}$",
    validate: (value) => /^\d{10}$/.test(digits(value)),
    validationLevel: "format",
    source: {
      name: "Ministerio de Hacienda — Registro Único Tributario",
  ...
  HN: [{
    ...
    type: "RTN",
    label: "Registro Tributario Nacional",
    example: "08019999123456",
    regex: "^\\d{14}$",
    validate: (value) => /^\d{14}$/.test(digits(value)),
    validationLevel: "format",
    source: {
      name: "Servicio de Administración de Rentas — Consulta RTN",
  ...
  SV: [{
    ...
    validationLevel: "format",
    source: {
      name: "Ministerio de Hacienda — Dirección General de Impuestos Internos",
  ...
  PA: [{
    ...
    type: "RUC",
    label: "Registro Único de Contribuyentes",
    example: "155123456-2-2020",
    regex: "^[A-Z0-9-]{6,20}$",
    validate: (value) => /^[A-Z0-9-]{6,20}$/.test(value.trim().toUpperCase()),
    validationLevel: "format",
    source: {
      name: "Dirección General de Ingresos — Panamá",
  ...
  NI: [{
    ...
    type: "RUC",
    label: "Registro Único de Contribuyentes",
    example: "J0310000012345",
    regex: "^[A-Z0-9]{13,14}$",
    validate: (value) => /^[A-Z0-9]{13,14}$/.test(value.trim().toUpperCase().replace(/[\s-]/g, "")),
    validationLevel: "format",
    source: {
      name: "Dirección General de Ingresos — Nicaragua",
      url: "https://www.dgi.gob.ni/",
      accessedAt: "2026-07-30",
    },
  }],
  CU: [{
    ...
    type: "NIT",
    label: "Número de Identificación Tributaria",
    example: "K12345678901",
    regex: "^[A-Z0-9]{11}$",
    validate: (value) => /^[A-Z0-9]{11}$/.test(value.trim().toUpperCase().replace(/[\s-]/g, "")),
    validationLevel: "format",
    source: {
      name: "Oficina Nacional de Administración Tributaria — Cuba",
